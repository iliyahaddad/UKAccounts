...
public class SmallCompanyAccountsGeneratorTests
{
    private async Task<(AppDbContext context, SmallCompanyAccountsGenerator generator)> CreateContextAsync()
    {
        ...
        var logger = NullLogger<SmallCompanyAccountsGenerator>.Instance;

        var generator = new SmallCompanyAccountsGenerator(
            companyRepository,
            periodRepository,
            journalRepository,
            accountRepository,
    ...
    [Fact]
    public async Task GenerateAsync_ShouldGenerateSmallCompanyAccounts()
    {
        ...
        var request = new AccountsProductionRequest
        {
            ...
            Regime = AccountsRegime.SmallCompany,
        ...
        Assert.Contains("small_company_accounts_12345678_20251231.ixbrl", result.IxbrlPath);
    }
}
